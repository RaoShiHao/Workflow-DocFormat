...
Inverse (this skill): cluster Tbl* by table_format + those slot bags, not by the
specimen's r1_cN grid. Mapping (M) labels each source cell into a Tbl* slot;
apply paints from that label. cell_style_plan is not a source-cell classifier.
"""
...
from lib.whitelist import CELL_KEYS
